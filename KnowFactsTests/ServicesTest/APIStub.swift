 ...
 */
public func isPathRegex(_ pathRegex: String) -> HTTPStubsTestBlock {
...
public func isPathRegex(_ pathRegex: String, withHttpMethod method: String) -> HTTPStubsTestBlock {
    return { req in
